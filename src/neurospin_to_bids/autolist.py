...
def get_serie_number_for_add_SerieDescription(
        ...
        for rule_index, rule in enumerate(rules):
            if rule_matches(rule, series_description):
                ...
                if 'add_file' in rule:
                    ...
                    add_series_number = get_serie_number_for_add_SerieDescription(
                        add_SerieDescription, series_number, series_list
                    )
